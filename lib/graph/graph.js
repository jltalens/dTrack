...
(function(){
    ...
    var parser = require('../parser'),
        ...
        requireHelpers = require('../builders').dependencyBuilder.getBuilder('AMD'),
        map;
     ...
     * @returns {{}}
     */
    var readFromFile = function readFromFile(filename, configFile, root) {
        ...
        var getMapFromConfig = function getMapFromConfig(configFile) {
            return requireHelpers.requireMaps(configFile);
        };
        ...
        var dependencyConstructor = function dependencyConstructor(filename, rootDir, struc) {
            ...
            while ((moduleName = pool.pop())) {
                dependenciesOfFile = requireHelpers.getAMDDependencies(fullFilePath(moduleName));
        ...
        var buildFromFile = function buildFromFile(filename) {
            ...
            structure[file] = {};
            var deps = requireHelpers.getAMDDependencies(filename);
