...
describe('ES6 Analyzer', () => {
  ...
  it('gets multiple level of nested dependencies', () => {
    let dependencies = analyzer.generateDependencyObject(__dirname + '/../../samples/es6-multiple-nested-same-dir.js');
  ...
  describe('bugs', () => {
    it('outputs the right name independently of being written with single or double quotes', () => {
      let dependencies = analyzer.generateDependencyObject(__dirname + '/../../samples/es6-single-import-double-quote.js');
