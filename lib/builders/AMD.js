...
(function(){
     ...
     * @returns {*}
     */
    var getFileFromKey = function getFileFromKey(dependency, mapfile) {
        map = (typeof map === 'undefined') ? requireMaps(mapfile) : map;
        return (typeof map !== 'undefined' && map[dependency]) ? map[dependency] : dependency ;
    };
